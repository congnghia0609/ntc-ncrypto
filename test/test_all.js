...
describe('Test 1: encode/decode', () => {
  ...
  it('Encode Base64Url', () => {
    assert.equal(b64data, 'lOpFwywpCeVAcK0_LOKG-YtW71xyj1bX06CcW7VZMFc=');
  });
  it('Encode Base64Url length', () => {
    assert.equal(b64data.length, 44);
  });
  it('Encode Hex', () => {
    assert.equal(hexdata, '94ea45c32c2909e54070ad3f2ce286f98b56ef5c728f56d7d3a09c5bb5593057');
  });
  it('Encode Hex length', () => {
    assert.equal(hexdata.length, 64);
  });
  it('Decode Base64Url', () => {
    assert.equal(numb64decode.toString(10), '67356225285819719212258382314594931188352598651646313425411610888829358649431');
  });
  it('Decode Hex', () => {
    assert.equal(numhexdecode.toString(10), '67356225285819719212258382314594931188352598651646313425411610888829358649431');
  });
});


// Test 2: split & merge
describe('Test 2: split & merge', () => {
  beforeEach((done) => {
      //Before each test we empty the database in your case
      done();
  });
  ...
  it('Test inNumbers', () => {
    assert.equal(sss.inNumbers(arr, value), true);
  });
  it('split & merge', () => {
    assert.equal(rs, s);
  });
...
// Test 3: encode/decode Hex
describe('Test 3: encode/decode Hex', () => {
  beforeEach((done) => {
      //Before each test we empty the database in your case
      done();
  });
...
// Test 4: encode/decode Hex
describe('Test 4: combine Hex', () => {
  beforeEach((done) => {
      //Before each test we empty the database in your case
      done();
  });
...
// Test 5: encode/decode Base64Url
describe('Test 5: encode/decode Base64Url', () => {
  beforeEach((done) => {
      //Before each test we empty the database in your case
      done();
  });
...
// Test 6: combine Base64Url
describe('Test 6: combine Base64Url', () => {
  beforeEach((done) => {
      //Before each test we empty the database in your case
      done();
  });
